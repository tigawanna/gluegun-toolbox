...
interface GluegunStrings {
     ...
     */
    trim(sourceString: string): string;
    /**
     * Strips whitespace from the start of a string.
     */
    trimStart(sourceString: string): string;
    /**
     * Strips whitespace from the end of a string.
     */
    trimEnd(sourceString: string): string;
    /**
...
declare const strings: GluegunStrings;
...
interface GluegunSystem {
     ...
     */
    run(command: string, args?: readonly string[] | undefined, options?: Options<string> | undefined): Promise<ExecaReturnValue<string> | undefined>;
    /**
